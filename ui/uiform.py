...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineFilenameBackground = QtWidgets.QLineEdit(Form)
        self.lineFilenameBackground.setGeometry(QtCore.QRect(20, 390, 381, 27))
        self.lineFilenameBackground.setObjectName("lineFilenameBackground")
        ...
        self.buttonPlay.setGeometry(QtCore.QRect(220, 430, 99, 27))
